...
from search import youtubeSearch_and_play
...
# Load intents
intents_path = "//Users/09hritik/Jarvis/jarvis/brain/Json/intents.json"
...
def chat():
    ...
    verify_face("/Users/09hritik/Jarvis/jarvis/brain/features/photos/hritik.jpeg")
    while True:
        message = listen()
        if message == 'shutdown':
            speak2("Goodbye!")
        ...
        if responses:
            ...
            if intent == "youtube":
                youtubeSearch_and_play(message)
                sleep(20)
